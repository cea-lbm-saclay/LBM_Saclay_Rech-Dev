 ...
 */
#ifndef SETUP_GP_MIXT_NS_H_
#define SETUP_GP_MIXT_NS_H_

#include "../ProblemFactory.h"
#include "Problem_GPMixtNS.h"

namespace PBM_GP_MIXT_NS{
struct pbm_registerer_GP_Mixt_NS
{

    
    
    pbm_registerer_GP_Mixt_NS()
    {

        register_problem<Problem, ModelParams::Tag2Quadra>("PF_GP_mixt_with_NS", "two_quadratic");
...
static pbm_registerer_GP_Mixt_NS registerer_GP_mixt_ns;

}

#endif //SETUP_GP_MIXT_NS_H_
