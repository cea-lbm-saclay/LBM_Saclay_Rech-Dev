#ifndef INDEX_NS_SURFACTANT_H
#define INDEX_NS_SURFACTANT_H
...
enum ComponentIndex {
  ...
  IFTSX,       /*!< Force Capillaire X */
  IFTSY,		 /*!< Force Capillaire Y */
  ISIGMA,		 /*!< surface tension (when Marangoni force is active) */
...
struct index2names {
  static int2str_t get_id2names() {
    ...
    map[IFMARAX] = "forceMaX";
    map[IFMARAY] = "forceMaY";
    map[IFTSX] = "forceTSX";
    map[IFTSY] = "forceTSY";
    map[ISIGMA] = "sigma";
