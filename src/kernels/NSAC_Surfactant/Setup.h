 ...
 */
#ifndef SETUP_NS_SURFACTANT_H
#define SETUP_NS_SURFACTANT_H

#include "../ProblemFactory.h"
#include "Problem_NS_Surfactant.h"

namespace PBM_NS_Surfactant  {
struct pbm_registerer_PBM_NS_Surfactant 
{
    
    
    pbm_registerer_PBM_NS_Surfactant ()
    {

        register_problem<Problem, ModelParams::TagCompo>("NSAC_Surfactant", "base");
        register_problem<Problem, ModelParams::TagSansGamma>("NSAC_Surfactant", "sansGamma");
    };

};


static pbm_registerer_PBM_NS_Surfactant  registerer_PBM_NS_Surfactant ;
}
