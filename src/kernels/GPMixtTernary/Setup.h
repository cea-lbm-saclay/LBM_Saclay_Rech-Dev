 ...
 */
#ifndef SETUP_GP_MIXT_TERNARY_H_
#define SETUP_GP_MIXT_TERNARY_H_

#include "../ProblemFactory.h"
#include "Problem_GPMixtTernary.h"
namespace PBM_GP_MIXT_TERNARY {
struct pbm_registerer_GP_Mixt_Ternary
{

    
    
    pbm_registerer_GP_Mixt_Ternary()
    {

        register_problem<Problem, ModelParams::Tag2Quadra>("ternary_GP_mixt", "two_quadratic");
        register_problem<Problem, ModelParams::Tag2Dilute>("ternary_GP_mixt", "two_dilute");
        register_problem<Problem, ModelParams::Tag2DiluteSolid>("ternary_GP_mixt", "two_dilute_solid");
        register_problem<Problem, ModelParams::Tag2DiluteInstantDiffusion>("ternary_GP_mixt", "two_dilute_instant_diffusion");
    };

};


static pbm_registerer_GP_Mixt_Ternary registerer_GP_mixt_ternary;
}

#endif //SETUP_GP_MIXT_TERNARY_H_
