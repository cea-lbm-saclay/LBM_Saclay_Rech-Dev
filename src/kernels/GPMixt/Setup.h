 ...
 */
#ifndef SETUP_GP_MIXT_H_
#define SETUP_GP_MIXT_H_

#include "../ProblemFactory.h"
#include "Problem_GPMixt.h"

namespace PBM_GP_MIXT {
struct pbm_registerer_GP_Mixt
{

    
    
    pbm_registerer_GP_Mixt()
    {

        register_problem<Problem, ModelParams::Tag2Quadra>("dissolution_GP_mixt", "two_quadratic");
        register_problem<Problem, ModelParams::Tag2Quadra>("dissolution_GP_mixt", "two_quadratic_sloped");
        register_problem<Problem, ModelParams::Tag2Dilute>("dissolution_GP_mixt", "two_dilute");
        register_problem<Problem, ModelParams::TagGPBringedal>("dissolution_GP_mixt", "bringedal");
    };

};


static pbm_registerer_GP_Mixt registerer_GP_mixt;

}

#endif //SETUP_GP_MIXT_H_
