 ...
 */
#ifndef SETUP_DIRECT_SOLIDIFICATION_H_
#define SETUP_DIRECT_SOLIDIFICATION_H_
...
struct pbm_registerer
{
    ...
    pbm_registerer()
    {
        ...
        register_problem<Problem, ModelParams::Tag2Quadra>("crystal_growth_younsi", "BasicModel");
    };
...
#endif //SETUP_DIRECT_SOLIDIFICATION_H_
