 ...
 */
#ifndef SETUP_NSAC_FAKHARI_H_
#define SETUP_NSAC_FAKHARI_H_

#include "../ProblemFactory.h"
#include "Problem_NS_AC_Fakhari.h"
...
struct pbm_registerer
{
    ...
    pbm_registerer()
    {
        ...
        register_problem<Problem, ModelParams::TagFakhari>("NSAC_Fakhari", "base");
    };
