#ifndef PROBLEM_NS_2AC_C_H_
#define PROBLEM_NS_2AC_C_H_
...
struct Problem : public ProblemBase<dim, npop> {
    ...
    void init_f() override
    {
        ...
        //~ else if (params.collisionType1 == TRT)  {init1eq<EquationTag1, TRTCollider<dim,npop>>();}
        ...
        if (params.collisionType4 == BGK) {
            ...
            init1eq<EquationTag4, MRTCollider<dim, npop>>();
        }
    }
    ...
    void update_f() override
    {
        ...
        if (params.collisionType4 == BGK) {
            ...
            update1eq<EquationTag4, MRTCollider<dim, npop>>();
        }
    }
