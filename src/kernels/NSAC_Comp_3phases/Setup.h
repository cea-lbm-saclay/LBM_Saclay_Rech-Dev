 ...
 */
#ifndef SETUP_NSAC_comp_3phases_2donly_H_   // change this
#define SETUP_NSAC_comp_3phases_2donly_H_   // change this

#include "../ProblemFactory.h"
#include "Problem.h"        // change this line

namespace NSAC_comp_3phases_2donly {  // change the namespace name
// this is step 1
struct pbm_registerer
{
    ...
    pbm_registerer()
    {
        ...
        register_problem<Problem, ModelParams::TagCompo>("NSAC_Comp_3phases", "base");
        register_problem<Problem, ModelParams::TagSansGamma>("NSAC_Comp_3phases", "sansGamma");
    };
...
#endif //SETUP_NSAC_comp_3phases_2donly_H_
