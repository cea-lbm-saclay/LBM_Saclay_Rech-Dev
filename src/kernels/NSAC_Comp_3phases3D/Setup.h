 ...
 */
#ifndef SETUP_PBM_NS_2AC_Compo3D_H_
#define SETUP_PBM_NS_2AC_Compo3D_H_
...
struct pbm_registerer
{
    ...
    pbm_registerer()
    {
        ...
        register_problem<Problem, ModelParams::TagCompo>("NSAC_Comp_3phases3d", "base");
        register_problem<Problem, ModelParams::TagSansGamma>("NSAC_Comp_3phases3d", "sansGamma");
    };
...
#endif //SETUP_PBM_NS_2AC_Compo3D_H_
