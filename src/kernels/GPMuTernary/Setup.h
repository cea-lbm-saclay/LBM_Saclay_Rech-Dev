 ...
 */
#ifndef SETUP_GP_MU_TERNARY_H_
#define SETUP_GP_MU_TERNARY_H_

#include "../ProblemFactory.h"
#include "Problem_GPMuTernary.h"
...
struct pbm_registerer
{
    ...
    pbm_registerer()
    {
        using namespace PBM_GP_MU_TERNARY;

        register_problem<Problem, ModelParams::Tag2Quadra>("ternary_GP_mu", "two_quadratic");
        register_problem<Problem, ModelParams::Tag2Dilute>("ternary_GP_mu", "two_dilute");
