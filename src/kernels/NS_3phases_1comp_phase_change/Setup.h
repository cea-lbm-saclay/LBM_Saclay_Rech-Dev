 ...
 */
#ifndef SETUP_NS3PHASES_1COMP_PHASECHANGE_H_
#define SETUP_NS3PHASES_1COMP_PHASECHANGE_H_

#include "../ProblemFactory.h"
#include "Problem_NS_2AC_Comp3D.h"

// enter the problem namespace
...
struct pbm_registerer
{
    ...
    pbm_registerer()
    {
        ...
        register_problem<Problem, ModelParams::TagCompo>("NS_3phases_1comp_phase_change", "base");
        register_problem<Problem, ModelParams::TagSansGamma>("NS_3phases_1comp_phase_change", "sansGamma");
    };
